...
public final class Constants {
    ...
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "pearl.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "pearl.updater.uri";
